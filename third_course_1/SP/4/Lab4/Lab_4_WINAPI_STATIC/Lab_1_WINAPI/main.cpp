...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        hCustomListView = new Table(hwnd, CUSTOM_LIST_VIEW_ROW_COUNT, CUSTOM_LIST_VIEW_COL_COUNT, hHeaderFont, hCellFont);
        hCustomListView->Show();

        for (int i = 0; i < CUSTOM_LIST_VIEW_COL_COUNT; i++)
        {
            hCustomListView->AddColumn(i, L"Header" + std::to_wstring(i));
        }
        ...
        for (int i = 0; i < CUSTOM_LIST_VIEW_ROW_COUNT; i++)
        {
            ...
            {
                hCustomListView->AddItem(i, j, L"File" + std::to_wstring(i));
            }
        }
    ...
    case WM_HEADER_CLICK: 
        ...
        std::wstring message = L"WM_HEADER_CLICK - Item: " + std::to_wstring(itemIndex) +
    ...
    case WM_DRAWITEM:
    {
        ...
        if (lpDrawItem->CtlID == ID_SELECT_FONT_BTN) {
            ...
            HBRUSH hBrush = CreateSolidBrush(RGB(130, 255, 255)); 
